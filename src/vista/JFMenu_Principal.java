...
public class JFMenu_Principal extends javax.swing.JFrame {
    ...
    public JFMenu_Principal() {
        ...
        // this.setExtendedState(this.MAXIMIZED_BOTH);//Me muestra la ventana en
        // pantalla completa desde el inicio del programa
        this.setLayout(null);

        // Instancia de JDesktoPane
        JFmenu_principal = new JDesktopPane();
        // int ancho= java.awt.Toolkit.getDefaultToolkit().getScreenSize().width;//Se
        // usa para el alto del panel
        // int alto= java.awt.Toolkit.getDefaultToolkit().getScreenSize().height;//Se
        // usa para el ancho del panel
